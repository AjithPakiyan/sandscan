...
PIXELS_PER_MM = 10      # for 10 cm camera height
MIN_AREA = 30
MAX_AREA = 5000
...
def upload():
    ...
    lat = request.headers.get("Latitude", "0")
    lon = request.headers.get("Longitude", "0")
    ...
    # ===== CLASSIFICATION =====
    if avg_size < 1.5:     #0.25
        grain_class = "Fine"
    elif avg_size <= 2.5:    #0.5
        grain_class = "Medium"
    else:
        grain_class = "Coarse"
